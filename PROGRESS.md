...
#### 6.3 API 엔드포인트 개발 ✅
- [x] `/api/v1/sourcing/search` - 도매 상품 검색
- [x] `/api/v1/sourcing/product/:id` - 상세 조회
- [x] `/api/v1/sourcing/calculate-price` - 가격 계산
- [x] `/api/v1/sourcing/generate-listing` - AI 리스팅 생성 (시뮬레이션)
- [x] `/api/v1/sourcing/register` - 쿠팡 등록 (시뮬레이션)
- [x] 입력 검증 (Zod 스키마)
- [x] 서버 라우트 통합

#### 6.4 프론트엔드 UI ✅
- [x] API 클라이언트 확장 (도매 소싱 메서드)
- [x] 가격 계산기 컴포넌트 (`PricingCalculator.tsx`)
- [x] 소싱 페이지 (`/dashboard/sourcing`)
- [x] 대시보드 메뉴 통합
- [x] 3가지 가격 전략 UI
- [x] 실시간 마진율 표시
- [x] 수익 예측 표시
...
#### 6.5 데이터베이스 확장
- [ ] WholesaleProduct 테이블
- [ ] SourcingListing 테이블
- [ ] PriceHistory 테이블

**📄 상세 명세**: [WHOLESALE_SOURCING_FEATURE.md](./docs/WHOLESALE_SOURCING_FEATURE.md)
